...
if(NOT EXISTS "/workspace/repos/glomap/build/_deps/poselib-build/install_manifest.txt")
  message(FATAL_ERROR "Cannot find install manifest: /workspace/repos/glomap/build/_deps/poselib-build/install_manifest.txt")
endif()

# remove files from 'install_manifest.txt'
message(STATUS "")
message(STATUS "Removing files from 'install_manifest.txt'")
file(READ "/workspace/repos/glomap/build/_deps/poselib-build/install_manifest.txt" files)
string(REGEX REPLACE "\n" ";" files "${files}")
foreach(file ${files})
  message(STATUS "Uninstalling $ENV{DESTDIR}${file}")
  if(IS_SYMLINK "$ENV{DESTDIR}${file}" OR EXISTS "$ENV{DESTDIR}${file}")
    exec_program("/workspace/repos/glomap/tmp_cmake_3-28-0/cmake-3.28.0-linux-x86_64/bin/cmake" ARGS "-E remove \"$ENV{DESTDIR}${file}\""
